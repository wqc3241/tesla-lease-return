...
export const INITIAL_VEHICLE_STATE: VehicleState = {
  ...
  softwareVersion: '2024.14.9',
  odometer: 12450,
};

export const INITIAL_LEASE_STATE: LeaseState = {
  termMonths: 36,
...
export const ICONS = {
  ...
  Flash: (props: any) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m13 2-2 10h3l-2 10" />
    </svg>
  ),
  Honk: (props: any) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3 12h1m8-9v1m8 8h1m-9 8v1M5.6 5.6l.7.7m11.4 11.4.7.7M18.4 5.6l-.7.7M5.6 18.4l.7-.7" />
